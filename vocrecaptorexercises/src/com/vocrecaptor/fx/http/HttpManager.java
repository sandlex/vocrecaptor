...
public class HttpManager {
    ...
    /**
     * Retrieves a list of languages to provide selection for anonymous users.
     *
     * @return xml-string containing languages
     * @throws java.lang.Exception
     */
    static public String getLanguageList(String userId) throws Exception {
        return performHttpPostRequest(SERVER_URL + "/vocrecaptorweb/getLanguages",
     ...
     * @throws java.lang.Exception
     */
    static public String getDictionaryList(int userId, String publicCriteria, String learn, String through) throws Exception {
        return performHttpPostRequest(SERVER_URL + "/vocrecaptorweb/getDictionaries",
                "<fields><field name=\"userId\">" + userId + "</field>" +
                "<field name=\"pub\">" + publicCriteria + "</field>" +
                "<field name=\"learn\">" + learn + "</field>" +
                "<field name=\"through\">" + through + "</field></fields>");
    }
